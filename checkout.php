...
if(isset($_POST['order_btn'])){
   ...
   if (detectIntrusion($name) === 'Intrusion Detected' || detectIntrusion($number) === 'Intrusion Detected' || detectIntrusion($email) === 'Intrusion Detected' || detectIntrusion($method) === 'Intrusion Detected' || detectIntrusion($address) === 'Intrusion Detected') {
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="credit card" disabled>credit card (tamporary unavilable)</option>
               <option value="paypal" disabled>UPI (tamporary unavilable)</option>
            </select>
         </div>
         <div class="inputBox">
